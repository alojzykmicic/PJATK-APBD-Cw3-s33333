...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        return przedmiot != null
            ? new[] { $"{przedmiot.Nazwa} | {przedmiot.DataStartu:yy-MM-dd}" }
    ...
    public IEnumerable<string> Zadanie09_TrzyNajnowszeZapisy()
    {
        return DaneUczelni.Zapisy
            ...
            .Take(3)
            .Select(z => $"{z.DataZapisu:MM/dd/yyyy} | Student: {z.StudentId} | Przedmiot: {z.PrzedmiotId}");
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .GroupBy(x => x.Nazwa)
            .Select(g =>
                $"{g.Key}: {g.Average(x => x.OcenaKoncowa.Value):F2}");
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Zapisy
            ...
            .Select(g =>
                $"{g.Key.Imie} {g.Key.Nazwisko}: {g.Max(x => x.OcenaKoncowa.Value)}");
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy.Select(pr =>
        {
            var oceny = DaneUczelni.Przedmioty
                ...
                .Select(o => o.Value)
                .ToList();
            string wynikiSredniej = oceny.Any() ? oceny.Average().ToString("F2") : "Brak ocen";
            return $"{pr.Imie} {pr.Nazwisko} | Średnia: {wynikiSredniej}";
        });
    }
    ...
    {
        return DaneUczelni.Studenci
            .Join(DaneUczelni.Zapisy.Where(z => z.CzyAktywny), s => s.Id, z => z.StudentId, 
                (s, z) => s.Miasto)
